...
class DnC(FedAvg):
    """Configurable DnC (Divide-and-Conquer) strategy implementation."""
    ...
    def aggregate_fit(
        ...
        num_malicious = len([value for value in clients_state.values() if value])
        parameters_aggregated = aggregate_dnc(weights_results, self.c, self.b, self.niters, num_malicious)
